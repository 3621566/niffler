...
import niffler.utilities.DateUtils;
...
public class SpendCondition {
    ...
    public static CollectionCondition spends(List<SpendJson> expectedSpends) {
        return new CollectionCondition() {
            ...
            public void fail(CollectionSource collection, @Nullable List<WebElement> elements, @Nullable Exception lastError, long timeoutMs) {
                if (elements == null || elements.isEmpty()) {
                    ...
                    throw new SpendsMismatch(collection, expectedSpends, bindElementsToSpends(elements), explanation, timeoutMs);
                }
            }
            ...
            public boolean test(List<WebElement> elements) {
                ...
                for (int i = 0; i < expectedSpends.size(); i++) {
                    ...
                    SpendJson expectedSpending = expectedSpends.get(i);
